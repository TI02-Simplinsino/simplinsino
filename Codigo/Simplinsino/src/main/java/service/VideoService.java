...
public class VideoService {
	public static String getVideo() {
		...
		for(int i = 0; i < videos.size(); i++) {
            ...
            videoJsonObj.put("id_curso", video.getId_curso());
	...
	public static String searchVideo(Request request) {
		...
		if(video.getId_video() != -1) {
            ...
            videoObj.put("id_curso", video.getId_curso());
	...
	public static boolean insertVideo(Request request) {
		...
		int id_videoSearch = Integer.parseInt(request.params(":id_video"));
		int id_curso = Integer.parseInt(request.params(":id_curso"));
		...
		boolean resp = videoDao.insert(new Video(id_videoSearch, id_curso, link_video, descricao_video, nome_video));
	...
	public static boolean updateVideo(Request request) {
		...
		boolean resp = videoDao.update(new Video(id_videoSearch, id_curso, link_video, descricao_video, nome_video));
