...
public class Aluno {
	...
	public Aluno() {
		this(-1,"nenhum","a","fas","sdfa");
	}
	
	public Aluno(int id_aluno, String usuario_aluno,String nome_aluno,String email_aluno,String senha_aluno) {
		super();
	...
	public String toString() {
        ...
        + " Email: " + this.getEmail_aluno() +  " Senha: " + this.getSenha_aluno(); 
	}
}
