...
public class AlunoDAO extends DAO {
	...
	public boolean insert(Aluno p) {
		...
		try {
			String query = "INSERT INTO aluno (id_aluno,usuario_aluno,nome_aluno,email_aluno,senha_aluno) VALUES"
					+ " (" +
					p.getId_aluno() + ", '" + p.getUsuario_aluno() + "', '" + p.getNome_aluno() +  "', '" + p.getEmail_aluno() + "', '" + p.getSenha_aluno()+"' );";
	...
	public List<Aluno> get(){
		...
		try {
			...
			while(rs.next()) {
				Aluno aluno = new Aluno(rs.getInt("id_aluno"),rs.getString("usuario_aluno"),rs.getString("nome_aluno"),rs.getString("email_aluno"),rs.getString("senha_aluno"));
				alunos.add(aluno);
			}
